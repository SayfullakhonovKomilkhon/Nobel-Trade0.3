...
import videoMp4 from '../../video/Презентация KMS.mp4'
import videoWebm from '../../video/Презентация.webm.webm'
    ...
    return (
        <>
            <div className="video-player">
                <video ref={videoRef} muted autoplay loop preload="auto" className="video">
